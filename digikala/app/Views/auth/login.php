...
<body class="bg-[#F0F0F1]">
  ...
  <div class="min-h-screen flex items-center justify-center px-4">
    <div class="w-full max-w-[420px] bg-white rounded-2xl p-6 border border-gray-200">
      ...
      <h1 class="font-bold text-[18px] mb-4">ورود</h1>
      ...
      <form method="post" class="space-y-3">
        ...
        <button class="w-full bg-[#ED1944] text-white rounded-xl p-3 font-bold">ورود</button>
      </form>

      <div class="text-[13px] mt-4">
        حساب نداری؟
        <a class="text-[#19BFD3]" href="<?= BASE_URL ?>/mvc.php?url=auth/register">ثبت نام</a>
      </div>
